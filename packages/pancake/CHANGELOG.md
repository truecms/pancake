...
- Multiple organisations can be used, for example `@truecms @nsw.gov.au` (legacy releases previously used `@gov.au`).
...
- Tweaked a couple functions so syrup can reuse them ([#17](https://github.com/truecms/pancake/issues/17))

## v1.0.13

- Enabled loading animation for plugin install ([#20](https://github.com/truecms/pancake/issues/20))

## v1.0.12

- stdio output to inherit so we can debug why plugin install is hanging ([#20](https://github.com/truecms/pancake/issues/20))

## v1.0.11

- Fixed npm waiting for lock files inside the plugin install ([#20](https://github.com/truecms/pancake/issues/20))

## v1.0.10

- Working on making the plugin install faster ([#20](https://github.com/truecms/pancake/issues/20))

## v1.0.9

- Get loading working inside child.process ([#21](https://github.com/truecms/pancake/issues/21))
- Increase speed in which the plugins are installed ([#20](https://github.com/truecms/pancake/issues/20))
